...
class Shortener(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        # The GET is to retrieve the shortened URI??

        # A GET request will either be for / (the root path) or for /some-name.
        # Strip off the / and we have either empty string or a name.

        # unquote xx[1:] replaces escapes with their single-character
        #   equivalent - eg. %7E with ~
    ...
    def do_POST(self):
        ...
        # Check that the user submitted BOTH of the form fields.
